...
namespace FTN.Common
{
    ...
    public class ModelResourcesDesc
    {
        ...
        // TODO proveri da li je dobar redosled
        private void InitializeTypeIdsInInsertOrder()
        {
            ...
            typeIdsInInsertOrder.Add(ModelCode.PERLENGTHSEQUENCEIMPENDANCE);
        ...
        // TODO ovde GID i reference (ona strana sa 0...*)
        private void InitializeNotSettablePropertyIds()
        {
            notSettablePropertyIds.Add(ModelCode.IDOBJ_GID);
            notSettablePropertyIds.Add(ModelCode.PERLENGTHIMPENDANCE_ACLINESEGMENT);
            notSettablePropertyIds.Add(ModelCode.EQUIPMENTCONTAINER_EQUIPMENT);
            notSettablePropertyIds.Add(ModelCode.SUBGEOGRAPHICALREGION_LINE);
        }
